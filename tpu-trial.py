...
def model_train_validate_test(train_df, dev_df, test_df, target_dir, trigger_words, **kwargs):
    ...
    train_loader = DataLoader(train_data, shuffle=True, batch_size=kwargs.get('batch_size', 256), , num_workers=4)
    dev_loader = DataLoader(dev_data, shuffle=True, batch_size=kwargs.get('batch_size', 256), , num_workers=4)
    test_loader = DataLoader(test_data, shuffle=False, batch_size=kwargs.get('batch_size', 256), , num_workers=4)
...
def main():
    ...
    target_dir = data_path + "output/Bert/"
